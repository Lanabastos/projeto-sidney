...
import logo from './assets/DO PIAUI PARA O MUNDO.png';
...
`;
  ...
  return (
    <div className="min-h-screen bg-slate-100 p-8">
      <div className="max-w-7xl mx-auto bg-blue rounded-[32px] shadow-2xl p-10 space-y-8">
    ...
    <div>
      ...
      <p className="text-gray-300 mt-2 text-lg">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <input
            className="bg-white text-gray-900 border border-gray-300 rounded-2xl p-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <input
            ...
            placeholder="Responsável Geral"
            name="responsavelGeral"
            value={formData.responsavelGeral}
            onChange={handleChange}
          />
        </section>
        ...
        <section className="space-y-6">
          ...
          {activities.map((activity, index) => (
            <div
              key={index}
              className="border border-gray-200 rounded-3xl p-6 bg-gray-50 space-y-4"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <input
                  type="time"
                  className="bg-white text-gray-900 border border-gray-300 rounded-2xl p-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  value={activity.horario}
                  onChange={(e) =>
                    handleActivityChange(index, 'horario', e.target.value)
                  }
                />

                <select
                  className="bg-white text-gray-900 border border-gray-300 rounded-2xl p-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  value={activity.turno}
                  onChange={(e) =>
                    handleActivityChange(index, 'turno', e.target.value)
                  }
                >
                  <option>Manhã</option>
                  <option>Tarde</option>
                ...
                <select
                  ...
                  value={activity.tipo}
                  onChange={(e) =>
                    handleActivityChange(index, 'tipo', e.target.value)
                  }
                >
                  <option>Aula</option>
              ...
              <input
                ...
                placeholder="Local"
                value={activity.local}
                onChange={(e) =>
                  handleActivityChange(index, 'local', e.target.value)
                }
              />
              ...
              <input
                ...
                onChange={(e) =>
                  handleActivityChange(index, 'responsavel', e.target.value)
                }
              />
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleActivityChange(index, 'descricao', e.target.value)
                }
              />
              ...
              <textarea
                ...
                value={activity.pedagogico}
                onChange={(e) =>
                  handleActivityChange(index, 'pedagogico', e.target.value)
                }
              />
              ...
              <textarea
                ...
                value={activity.observacoes}
                onChange={(e) =>
                  handleActivityChange(index, 'observacoes', e.target.value)
                }
              />
            </div>
          ))}
        ...
        <section>
          ...
          <textarea
            className="border rounded-xl p-3 w-full min-h-[150px]"
        ...
        <section>
          ...
          <div className="bg-gray-900 text-gray-100 rounded-3xl p-6 whitespace-pre-wrap text-sm leading-7 overflow-auto max-h-[700px]">
            {generateReport()}
          </div>
        </section>
